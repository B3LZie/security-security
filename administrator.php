<?php
  session_start();
  if(isset($_SESSION['log']) && $_SESSION['usergroup_id'] == '2'){
?>
<html>
<head>
...
<body>
  ...
  <a href="view.php"><button type="submit" name="logout" style="width:30%; height:8%;">My Profile</button></a> &nbsp;
  <a href="view.php"><button type="submit" name="logout" style="width:30%; height:8%;">View person details</button></a><br><br>
