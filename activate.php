...
if(isset($_POST["person_id"]) && !empty($_POST["person_id"])){
    ...
    $sql = "UPDATE person_details SET active = 1 WHERE person_id = ?";
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger fade in">
                            ...
                            <p>Are you sure you want to activate this record?</p><br>
                            <p>
                                <input type="submit" value="Yes" class="btn btn-danger">
                                <a href="#" class="btn btn-default" onclick="history.go(-1)">No</a>
                            </p>
